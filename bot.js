...
client.on('ebnklb',function(ebnklb) {
    ...
    if(ebnklb.content.startsWith(`<@${client.user.id}>`)) {
        ...
        ebnklb.channel.send('My Prefix `r`')
...
**
        ***__General orders__***
**
『rallbots/لعرض جميع البوتات الي بالسيرفر』
『rserver/يعرض لك معلومات عن السيرفر』
『rbot/يعرض لك كل معلومات البوت』
『rskin <name>/يعرض لك سكنك بماين كرافت』
『rcount/يعرض لك عدد الاشخاص بالسيرفر بدون بوتات』
『rinvites/ يعرض لك  عدد انفايتاتك بالسيرفر 』
『rinvite-codes/يعرض لك روابط الانفايتات حكك في السيرفر 』
『rcal/اله حاسبة』
『rtrans <language> <any thing>/يترجم لك الي تبيه من اي لغة』
『rshort/يختصر لك رابط كبير الى رابط صغير』
『rtag/يكتب لك الكلمة بشكل جميل وكبير』
『rgoogle/للبحث في قوقل عن طريق الدسكورد』
『rperms/يعرض لك برمشناتك بالسيرفر』
『ryn/تسأل بوت والبوت يجاوبك بنعم او لا』
『rw/امر يخليك مثل بوت تكتب عبره مع امر ويسويك بوت』
『rza5/يزخرف لك كلمة او جملة』
『rrooms/يعرض لك كل الرومات الي بالسيرفر مع عددها』
『rroles/يعرض لك كل الرانكات بالسيرفر بشكل جميل』
『remojilist/يعرض لك كل الايموجيات الي بالسيرفر』
『rsay/يكرر الكلام الي تكتبو』
『rimage/صورة السيرفر』
『rmembers/��عرض لك عدد كل حالات الاشخاص وعدد البوتات وعدد الاشخاص』
『rid/معلومات عنك』
『rprofile/عرض بروفايل حقك』
『rtc/انشاء روم مؤقت ويمكنك تحديد الاعدادات』
『rbans / عدد الاشخاص المبندة 』
『rvoice /  يوم لك بكتابه مجموع عدد الاشخاص الموجودين برومات』
『ravatar/صورتك او صورة الي تمنشنو』
『rembed/يكرر الي تقولو بشكل حلو』
『rdiscrim/كود يضهر لك الاشخاص نفس تاقك』
『remoji <any things>/لتحويل اي كلمه تقولها الي ايموجي』
『rsupport/سيرفر الدعم』
『rcontact/ارسال اقتراح او لمراسلة صاحب البوت』
**
  `
,`
        ***__Administrative Orders__***
**
『rmove @user /  لسحب الشخص الى روومك』
『rvoiceonline /  لتفعيل خاصيه فويس اونلاين يسحب عدد الاشخاص موجودين برومات』
『rbc / رسالة جماعية الى كل اعضاء السيرفر』
『rbcrole / لارسال رساله جماعي لرتبه محدده يجب تمنشنها 』
『rrole @user <rank> / لأعطاء رتبة لعضو معين』
『rroleremove @user <rank> / لازالة الرتبة من شخص معين』
『rrole all <rank> / لأعطاء رتبة للجميع』
『rrole humans <rank> / لأعطاء رتبة للاشخاص فقط』
『rrole bots <rank> / لأعطاء رتبة لجميع البوتات』
『rhchannel / اخفاء الشات』
『rschannel / اضهار الشات المخفية』
『rclr <numbr> / مسح الشات بعدد』
『rclear / مسح الشات』
『rmute @user <reason> / اعطاء العضو ميوت لازم رتبة <Muted>』
『runmute @user / لفك الميوت عن الشخص 』
『rkick @user <reason> / طرد الشخص من السيرفر』
『rban @user <reason> / حضر الشخص من السيرفر』
『rmutechannel / تقفيل الشات』
『runmutechannel / فتح الشات』
『rdc / مسح كل الرومات』
『rdr / <مسح كل الرانكات <لازم تكون رانك البوت فوق كل الرانكات』
『rct <name> / انشاء شات』
『rcv <name> / انشاء رووم فويس』
『rdelet <name> / مسح الشات او الرووم فويس』
『❖rccolors <number> / ينشا لك الوان مع كم الوان تبي』
   `,`
        ***__Music orders__***
**
...
『rلعبة فكك / فكك』
『rعواصم عشوائي/عواصم』
『rلعبة كت تويت / كت تويت』
『rroll <number> / قرعة』
『rلو خيروك بطريقة حلوة / لو خيروك』
『rلعبة مريم / مريم』
『rفوائد ونصائح  / هل تعلم』
『rيعطيك عقابات قاسية / عقاب 』
...
client.on("message", async message => {
        ...
        if(message.content.startsWith('rinvite-codes')) {
...
if (!points[message.author.id]) points[message.author.id] = {
  ...
  if(!message.guild) return;
    let id = message.author.id,prefix="r";
...
if (!message.content.startsWith(prefix)) return;
	...
	if (command == "mute") {
		if (!message.channel.guild) return;
		if(!message.guild.member(message.author).hasPermission("MANAGE_MESSAGES")) return message.reply("انت لا تملك صلاحيات r ").then(msg => msg.delete(5000));
...
client.on('message', message => {
    if(!message.guild) return;
    if (message.author.bot) return;
      let id = message.author.id,prefix="r";//البريفكس
...
client.on('message', message => {
    if (message.content.startsWith("rbans")) {
...
client.on("message", (message) => {
if (message.content.startsWith("rct")) {
...
client.on("message", (message) => {
if (message.content.startsWith("rcv")) {
            if (!message.member.hasPermission('MANAGE_CHANNELS')) return message.reply("You Don't Have `MANAGE_CHANNELS` Premissions ");
        let args = message.content.split(" ").slice(1);
...
client.on("message", (message) => {
    if (message.content.startsWith('rdelet')) {
        if (!message.member.hasPermission('MANAGE_CHANNELS')) return message.reply("You Don't Have `MANAGE_CHANNELS` Premissions ");
...
client.login("NTM3NzIwMTAwMjc5NjgxMDI0.DypXFA.uX7RAeDFhC-YfYea9GJOBtkV96g");
